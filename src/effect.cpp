...
FX::ParameterType FX::s_Parameter[FX::Unknown] =
{
	...
	{0, 127, 125, 1, "ZynSympatheticQSustain"},
...
static int getIDFromEffectName(const char *name)
{
	for (int i = 0; i < FX::effects_num; ++i)
