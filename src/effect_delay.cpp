...
static float32_t calculateTime(AudioEffectDelay::Sync sync, unsigned tempo)
{
...
void AudioEffectDelay::setTimeL(float32_t time)
{
...
void AudioEffectDelay::setTimeR(float32_t time)
{
...
void AudioEffectDelay::setTimeLSync(Sync sync)
{
    timeLSync = sync;
    if (sync != SYNC_NONE)
...
void AudioEffectDelay::setTimeRSync(Sync sync)
{
    timeRSync = sync;
    if (sync != SYNC_NONE)
...
void AudioEffectDelay::setTempo(unsigned t)
{
...
void AudioEffectDelay::resetState()
{
