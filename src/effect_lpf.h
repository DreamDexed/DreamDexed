...
public:
	...
	AudioEffectLPF(float32_t samplerate, float32_t cutoff, float32_t resonance):
	samplerate{samplerate},
	cutoff{constrain(cutoff * MAX_CUTOFF, MIN_CUTOFF, MAX_CUTOFF)},
	...
	void setCutoff(float32_t value)
	{
		setCutoff_Hz(value * MAX_CUTOFF);
	}

	float32_t getCutoff() { return cutoff / MAX_CUTOFF; }
