...
private:
	...
	CUIMenu::TCParameterInfo m_pEffectEncoders[3][nEncoder + nFader] = {
		...
		},
		{
			...
			{CUIMenu::ParameterGlobal, CMiniDexed::ParameterMasterCompressorPreGain, "MCr Pre Gain"},
			{CUIMenu::ParameterGlobal, CMiniDexed::ParameterMasterCompressorThresh, "MCr Thresh"},
			{CUIMenu::ParameterGlobal, CMiniDexed::ParameterMasterCompressorRatio, "MCr Ratio"},
			{CUIMenu::ParameterGlobal, CMiniDexed::ParameterMasterCompressorAttack, "MCr Attack"},
			{CUIMenu::ParameterGlobal, CMiniDexed::ParameterMasterCompressorRelease, "MCr Release"},
			{CUIMenu::ParameterGlobal, CMiniDexed::ParameterMasterCompressorHPFilterEnable, "MCr HP Filter"},
			{CUIMenu::ParameterNone},
