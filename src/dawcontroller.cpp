...
private:
	...
	CUIMenu::TCParameterInfo m_pMainEncoders[1 + 3 + 2 + 5 + 3 + 22][nEncoder + nFader] = {
		{
	...
	CUIMenu::TCParameterInfo m_pEffectEncoders[3][nEncoder + nFader] = {
		{
		...
		{
			{CUIMenu::ParameterGlobal, CMiniDexed::ParameterLimiterEnable, "Limiter"},
			{CUIMenu::ParameterGlobal, CMiniDexed::ParameterLimiterPreGain, "Lim Pre Gain"},
			{CUIMenu::ParameterGlobal, CMiniDexed::ParameterLimiterThresh, "Lim Thresh"},
			{CUIMenu::ParameterGlobal, CMiniDexed::ParameterLimiterRatio, "Lim Ratio"},
			{CUIMenu::ParameterGlobal, CMiniDexed::ParameterLimiterAttack, "Lim Attack"},
			{CUIMenu::ParameterGlobal, CMiniDexed::ParameterLimiterRelease, "Lim Release"},
			{CUIMenu::ParameterGlobal, CMiniDexed::ParameterLimiterHPFilterEnable, "Lim HP Filter"},
			{CUIMenu::ParameterNone},
	...
	CUIMenu::TCParameterInfo m_pTGEncoders[6 + 3 + 22][nEncoder + nFader] = {
		...
		},
		{
			...
			{CUIMenu::ParameterTG, CMiniDexed::TGParameterCompressorMakeupGain, "MakeupGain"},
			{CUIMenu::ParameterNone},
	...
	:m_pSynthesizer (pSynthesizer), m_pKeyboard (pKeyboard), m_pConfig (pConfig), m_pUI (pUI)
{
	...
	memcpy (m_pMainEncoders + 6, m_pTGEncoders + 1, sizeof *m_pTGEncoders * 5);
	memcpy (m_pMainEncoders + 11, m_pVoiceEncoders, sizeof m_pVoiceEncoders);
