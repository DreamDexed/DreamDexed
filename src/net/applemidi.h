...
{
public:
	virtual void OnAppleMIDIDataReceived(const uint8_t *pData, size_t nSize) = 0;
...
public:
	bool SendMIDIToHost(const uint8_t *pData, size_t nSize);
...
private:
	...
	bool SendPacket(CSocket *pSocket, CIPAddress *pIPAddress, uint16_t nPort, const void *pData, size_t nSize);
