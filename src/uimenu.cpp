...
{
	{"Enable",	EditGlobalParameter,	0,	CMiniDexed::ParameterLimiterEnable,		"LEn"},
	{"Pre Gain",	EditGlobalParameter,	0,	CMiniDexed::ParameterLimiterPreGain,		"LPG"},
	{"Threshold",	EditGlobalParameter,	0,	CMiniDexed::ParameterLimiterThresh,		"LTh"},
	{"Ratio",	EditGlobalParameter,	0,	CMiniDexed::ParameterLimiterRatio,		"LRa"},
	{"Attack",	EditGlobalParameter,	0,	CMiniDexed::ParameterLimiterAttack,		"LAt"},
	{"Release",	EditGlobalParameter,	0,	CMiniDexed::ParameterLimiterRelease,		"LRe"},
	{"HPFilter",	EditGlobalParameter,	0,	CMiniDexed::ParameterLimiterHPFilterEnable,	"LHP"},
	{0}
};
